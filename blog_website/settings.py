...
AUTHENTICATION_BACKENDS = (
    'user_profile.backends.EmailAuthBackend',   # custom auth backend
    'django.contrib.auth.backends.ModelBackend' # django default backend activates when username is used 
)
